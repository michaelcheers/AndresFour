...
Bridge.assembly("AndresFour", function ($asm, globals) {
        ...
        statics: {
            ...
            methods: {
                    ...
                    var $step = 0,
                        ...
                        $asyncBody = Bridge.fn.bind(this, function () {
                            for (;;) {
                                ...
                                switch ($step) {
                                    case 0: {
                                        $task1 = AndresFour.Level.Create(AndresFour.MainStarter.levelTemplate, "Untitled");
                                        $step = 1;
                                ...
                                for (;;) {
                                    ...
                                    switch ($step) {
                                        case 0: {
                                            ...
                                            $t = Bridge.getEnumerator(Object.keys(dStorage));
                                            $step = 1;
                                            continue;
                                        }
                                        case 1: {
                                        ...
                                        case 2: {
                                            $task1 = AndresFour.Level.Create(dStorage[System.Array.index(key, dStorage)], key);
                                            $step = 3;
                                            $task1.continueWith($asyncBody);
                                            return;
                                        }
                ...
                Refresh: function () {
                    ...
                    AndresFour.LevelEditor.CreateCell(AndresFour.LevelEditor.table, [($t=document.createElement('a'), $t.href = "javascript:void(0)", $t.innerHTML = "Create Rectangle", $t.onclick = $asm.$.AndresFour.LevelEditor.f3, $t)]);
                    ...
                    for (;;) {
                        ...
                        switch ($step) {
                            ...
                            case 1: {
                                ...
                                link.appendChild(($t=document.createElement('a'), $t.innerHTML = "Play Game", $t.onclick = $asm.$.AndresFour.MainStarter.f1, $t.href = "javascript:void(0)", $t));
                                list.appendChild(link);
                                list.appendChild(document.createElement('br'));
                                link = document.createElement('li');
                                link.appendChild(($t1=document.createElement('a'), $t1.innerHTML = "Level Editor", $t1.onclick = $asm.$.AndresFour.MainStarter.f2, $t1.href = "javascript:void(0)", $t1));
                                list.appendChild(link);
    ...
    Bridge.define("AndresFour.Shot", {
        ...
        methods: {
            Parse: function (dynamic) {
                var $t;
                this.Velocity = ($t=new AndresFour.Vector2(), $t.X = dynamic.vX, $t.Y = dynamic.vY, $t);
            ...
            Update: function ($in) {
                ...
                AndresFour.DrawnGameObject.prototype.Update.call(this, $in);
            }
        }
    });
    ...
    $m($n[1].Shot, function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"ov":true,"a":2,"n":"Parse","t":8,"pi":[{"n":"dynamic","pt":System.Object,"ps":0}],"sn":"Parse","rt":$n[2].Task,"p":[System.Object]},{"ov":true,"a":2,"n":"Save","t":8,"pi":[{"n":"dynamic","pt":System.Object,"ps":0}],"sn":"Save","rt":$n[3].Object,"p":[System.Object]},{"ov":true,"a":2,"n":"Update","t":8,"pi":[{"n":"in","pt":$n[1].Level,"ps":0}],"sn":"Update","rt":$n[3].Object,"p":[$n[1].Level]},{"a":2,"n":"Type","is":true,"t":4,"rt":$n[3].String,"sn":"Type"},{"a":2,"n":"Velocity","t":4,"rt":$n[1].Vector2,"sn":"Velocity"}]}; });
    $m($n[1].Vector2, function () { return {"att":1048841,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"X","t":4,"rt":$n[3].Double,"sn":"X"},{"a":2,"n":"Y","t":4,"rt":$n[3].Double,"sn":"Y"}]}; });
});
